...
<div class="row">
    ...
    <div class="col-sm-6 card card-display">
        <cc-text-output v-bind:displayText="textBoxValue1" :containerHeight="130"></cc-text-output>
        <cc-image-output :displayImage="imageName" :containerHeight="350" :clearImageProp="clearImage"></cc-image-output>
        <cc-text-output v-bind:displayText="textBoxValue2" :containerHeight="130"></cc-text-output>
        <cc-text-output v-bind:displayText="textBoxValue3" :containerHeight="130"></cc-text-output>
    </div>
</div>
